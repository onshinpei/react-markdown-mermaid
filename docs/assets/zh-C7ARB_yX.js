const e="react-markdown-mermaid 演示",n="一个用于在React应用中渲染Mermaid图表的轻量级组件和rehype插件",a={markdown:"React-Markdown 示例"},t={viewMermaidCode:"查看Mermaid代码",useMermaidBlock:"直接使用MermaidBlock组件",github:"GitHub",mermaidDocs:"Mermaid 文档",markdownExampleTitle:"React-Markdown + rehypeMermaid 示例",markdownExampleDescription:"这个示例展示了如何在 react-markdown 中使用 rehypeMermaid 插件来渲染 Mermaid 图表。",codeExample:"代码示例",renderEffect:"渲染效果",mermaidCode:"Mermaid 代码",reactUsageCode:"React 使用代码"},i={flowchart:{title:"流程图",description:"展示基本的流程图，包含条件判断和多个处理步骤。",code:`
    graph TD
      A[开始] --> B{判断条件}
      B -->|是| C[处理A]
      B -->|否| D[处理B]
...
}`},list:{title:"列表示例",items:["项目 1","项目 2","子项目 2.1","子项目 2.2","项目 3"]},table:{title:"表格示例",headers:["功能","状态","描述"],rows:[["流程图","✅","支持"],["序列图","✅","支持"],["甘特图","✅","支持"],["类图","✅","支持"],["饼图","✅","支持"],["状态图","✅","支持"]]},summary:{title:"总结",content:"这个示例展示了如何在 react-markdown 中使用 rehypeMermaid 插件来渲染 Mermaid 图表。插件会自动识别 markdown 中的 ```mermaid 代码块并将其转换为 MermaidBlock 组件。"}}},o={appTitle:e,appSubtitle:n,tabs:a,labels:t,examples:i,markdownExample:r};export{n as appSubtitle,e as appTitle,o as default,i as examples,t as labels,r as markdownExample,a as tabs};
